...
* \n\n\n\n
* Rev. A 2018-07-06 ITN003543-D01
*/
...
/// <summary>
/// The OPERATION_MODE enumeration defines the available mode for camera.
/// </summary>
...
/// <param name="image_buffer">The pointer to the buffer that contains the image data. IMPORTANT: This pointer is only valid for the duration of this callback.</param>
/// <param name="image_width_pixels">The image width in pixels.</param>
/// <param name="image_height_pixels">The image height in pixels.</param>
...
typedef void(*TL_CAMERA_FRAME_AVAILABLE_CALLBACK)(void* sender, unsigned short* image_buffer, int image_width_pixels, int image_height_pixels, int bit_depth, int number_of_color_channels, int frame_count, void* context);
...
/// <para>IMPORTANT: The memory is allocate inside the camera SDK. Therefore, the provided pointer will be set a position in the internal buffer. Either complete all tasks related to this image or make a copy the data before returning from this function. Once this function exits, the pointer to the image buffer becomes invalid.
/// </summary>
/// <param name="tl_camera_handle">The camera handle associated with the exposure request.</param>
/// <param name="image_buffer">A reference to receive the image data. IMPORTANT: This pointer is only valid for the duration of this function.</param>
/// <param name="image_width_pixels">A reference to receive the image width value.</param>
/// <param name="image_height_pixels">A reference to receive the image height value.</param>
/// <param name="bit_depth">A reference to receive the image bit depth value.</param>
/// <param name="number_of_color_channels">A reference to receive the image color channels value.</param>
/// <param name="frame_count">A reference to receive the frame count value.</param>
/// <returns>0 if successful or a positive integer error code to indicate failure.</returns>
typedef int(*TL_CAMERA_GET_PENDING_FRAME_OR_NULL)(void* tl_camera_handle, unsigned short** image_buffer, int* image_width_pixels, int* image_height_pixels, int* bit_depth, int* number_of_color_channels, int* frame_count);
...
/// <returns>0 if successful or a positive integer error code to indicate failure.</returns>
typedef int(*TL_CAMERA_GET_EXPOSURE_RANGE)(void* tl_camera_handle, int* exposure_time_us_min, int* exposure_time_us_max);
...
/// <summary>
/// Returns the time, in microseconds (μs), required for a frame to be exposed and read out from the sensor.
...
/// </summary>
typedef int(*TL_CAMERA_GET_COLOR_FILTER_ARRAY_PHASE)(void* tl_camera_handle, enum TSI_COLOR_FILTER_ARRAY_PHASE *cfaPhase);
...
/// <summary>
/// Gets the current sensor temperature_degrees_celcius in degrees Celsius.\n\n
/// The camera must have delivered frames prior to calling this function for the first time.
/// </summary>
/// <param name="tl_camera_handle">The camera handle associated with the temperature_degrees_celcius request.</param>
/// <param name="temperature_degrees_celcius">A reference that receives the current sensor temperature_degrees_celcius.</param>
/// <returns>0 if successful or a positive integer error code to indicate failure.</returns>
typedef int(*_GET_TEMPERATURE_DEGREES_C)(void* tl_camera_handle, int *temperature_degrees_celcius);
...
extern "C"
{
    ...
    extern _GET_TEMPERATURE_DEGREES_C _get_temperature_degrees_c;
