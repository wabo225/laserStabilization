...
_GET_TEMPERATURE_DEGREES_C _get_temperature_degrees_c;
...
int tl_camera_sdk_dll_initialize(void)
{
	...
	_get_temperature_degrees_c = (_GET_TEMPERATURE_DEGREES_C)get_module_function(sdk_handle, "_get_temperature_degrees_c");
	if (!_get_temperature_degrees_c)
	{
		return (init_error_cleanup());
	}
